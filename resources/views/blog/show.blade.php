...
<div class="container mx-auto px-4 py-10 md:px-6">
  <article class="mx-auto max-w-3xl">
    <img src="{{ $blog->image_url }}" alt="{{ $blog->title }}" class="mb-6 h-64 w-full rounded object-cover md:h-96" />
    ...
    <div class="mb-6 flex items-center gap-3 text-sm text-muted-foreground">
      <img src="{{ $blog->author_avatar }}" class="h-8 w-8 rounded-full" alt="{{ $blog->author_name }}" />
