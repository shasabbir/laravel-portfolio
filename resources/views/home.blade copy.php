  ...
  <div class="container mx-auto grid grid-cols-1 items-center gap-12 px-4 text-center md:grid-cols-2 md:px-6 md:text-left">
    ...
    <div class="z-10">
      ...
      <div class="mt-8 flex justify-center gap-4 md:justify-start">
        <a
          href="/publications"
          class="inline-flex items-center gap-2 rounded bg-primary px-5 py-3 text-primary-foreground shadow hover:opacity-90 transition"
        >
          View Publications
        </a>
        ...
        <a
          href="/contact"
          class="inline-flex items-center gap-2 rounded border border-border px-5 py-3 hover:bg-muted/20 transition"
        >
          Get in Touch
        </a>
      </div>
    ...
    <div class="relative flex justify-center">
      ...
      <!-- Blob 1 -->
      <div class="absolute inset-0 z-0 -translate-x-4 -translate-y-4 transform-gpu scale-50 md:scale-75">
        <svg
          viewBox="0 0 500 500"
          xmlns="http://www.w3.org/2000/svg"
          class="h-auto w-full origin-center animate-blob-1 text-primary/30 blur-xl"
        >
          <path
            fill="currentColor"
      ...
      <!-- Blob 2 -->
      <div class="absolute inset-0 z-0 transform-gpu scale-50 md:scale-75">
        <svg
          viewBox="0 0 500 500"
          xmlns="http://www.w3.org/2000/svg"
          class="h-auto w-full origin-center animate-blob-2 text-secondary/40"
        >
          <path
            fill="currentColor"
      ...
      <img
        ...
        class="relative z-10 h-64 w-64 rounded-full border-4 border-background object-cover shadow-lg md:h-80 md:w-80"
      />
    </div>
  </div>
</section>
